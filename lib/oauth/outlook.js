...
class OutlookOauth {
    constructor(opts) {
        console.log("Inside OutlookOAuth");
    ...
    generateAuthUrl(opts) {
        console.log("Inside generateAuthUrl");
        opts = opts || {};
    ...
    getTokenRequest(opts) {
        console.log("Praveen:: Inside getTokenRequest")
        opts = opts || {};
    ...
    async getToken(code) {
        console.log("Praveen:: getToken invoked")
        console.trace()
    ...
    async refreshToken(opts) {
        console.log("Praveen:: refresh token invoked")
        opts = opts || {};
